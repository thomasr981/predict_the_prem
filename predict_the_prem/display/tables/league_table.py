...
def create_league_table_html(league_table_df: pd.DataFrame) -> str:
    ...
    th.league-table-col-general,
    td.league-table-col-general {
        width: 30px;
        border-top: 1px solid black;
        border-bottom: 1px solid black;
    }

    th.league-table-col-badge,
    td.league-table-col-badge {
        width: 40px;
        border-top: 1px solid black;
        border-bottom: 1px solid black;
    }

    th.league-table-col-name,
    td.league-table-col-name {
        width: 100px;
        border-top: 1px solid black;
        border-bottom: 1px solid black;
    }

    th.league-table-col-form,
    td.league-table-col-form {
        width: 80px;
        border-top: 1px solid black;
        border-bottom: 1px solid black;
    }
    ...
    for team in team_records:
        html += f"""
            <tr>
                ...
                <td class="league-table-col-form" style="text-align: center">{team['form']}</td>
            </tr>
        """
    html += """
        </tbody>
